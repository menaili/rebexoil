...
$css = 'list-portfolio mf-list-portfolio';
...
?>
	...
	<div id="primary" class="content-area all-project <?php induscity_content_columns(); ?>">
		...
		<?php
		/*
		 *	induscity_portfolio_categories_filter -10
		 */
		do_action( 'induscity_before_portfolio_content' );
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php do_action( 'induscity_after_portfolio_content' ) ?>
		</div>
